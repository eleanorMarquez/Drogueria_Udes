        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-xl-12 col-sm-6 mb-3">
              ...
              <h4>Digite los siguientes datos para un exitoso registro y actualizacion de un Empleado</h4>
          ...
          <section class=" text-center">
            <form action="../funciones/updateEmpleado.php" enctype="multipart/form-data" method="post" >
              ...
              <div class="form-group row">
						    ...
						    <div class="col-sm-8">
									<input type="text" class="form-control" name="tipoempleado" value="<?php echo $registros['Tipo_Empleado']; ?>" readonly="readonly"  required>
						    </div>
							</div>

              <div class="form-group row">
						    <div class="col-sm-8">
									<input type="text" name="numeroId" value="<?php echo $registros['id_empleado']; ?>">
						    </div>
							</div>
