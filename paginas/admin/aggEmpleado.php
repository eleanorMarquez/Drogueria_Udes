      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Agg Empleado</li>
          </ol>
          ...
          <div class="row">
            <div class="col-xl-12 col-sm-6 mb-3">
              ...
              <h4>Digite los siguientes datos para un exitoso registro de un Empleado</h4>
          ...
          <section class=" text-center">
            <form action="../funciones/crearEmpleado.php" enctype="multipart/form-data" method="post" >
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control numero" id="codigo_aleatorio" name="Codigo" value="" placeholder="Digite un codigo para contraseña..." rquerid>
                </div>
              </div>


              <div class="form-group row">
                <label class="col-sm-3 col-form-label" for="sel1">Tipo Empleado: </label>
                <div class="col-sm-8">
                  <select class="form-control" id="tipempleado" name="tipoEmpleado" required>
    						    <option value="">Seleccione</option>
    						    <option value="Servicio General">Servicio General</option>
    						    <option value="Control Inventario">Control Inventario</option>
    						  </select>
                </div>
              </div>
