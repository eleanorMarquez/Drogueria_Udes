      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Actualizar Docente</li>
          </ol>
          ...
          <div class="row">
            <div class="col-xl-12 col-sm-6 mb-3">
              ...
              <h4>Digite los siguientes datos para un exitoso registro y actualizacion de un Docente</h4>
          ...
          <section class=" text-center">
            <form action="../funciones/updateDocente.php" enctype="multipart/form-data" method="post" >
              ...
              <br>
						    ...
						    <div class="col-sm-8">
									<input type="text" class="form-control letra" name="Apellido" value="<?php echo $registros['Apellidos']; ?>" placeholder="Digite tu Apellido..." required>
						    </div>
							</div>
              ...
              <div class="form-group row">
						    ...
						    <div class="col-sm-8">
									<input type="text" class="form-control" name="cedula" value="<?php echo $registros['Cedula']; ?>" placeholder="Ejemplo: Calle XX N° XX Barrio XX" >
						    </div>
							</div>
						    ...
						    <div class="col-sm-8">
									<input type="email" class="form-control" name="correo" value="<?php echo $registros['Correo']; ?>" placeholder="ejemplo@ejem.com" required>
						    </div>
							</div>
              ...
              <div class="form-group row">
						    ...
						    <div class="col-sm-8">
									<input type="text" class="form-control" name="tipoDocente" value="<?php echo $registros['Tipo_Usuario']; ?>" readonly="readonly"  required>
						    </div>
							</div>

              <div class="form-group row">
						    <div class="col-sm-8">
									<input type="text" name="numeroId" value="<?php echo $registros['id_docente']; ?>">
						    </div>
							</div>
