      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Agg Docente</li>
          </ol>
          ...
          <section class=" text-center">
            <form action="../../funciones/docente/crearDo.php" enctype="multipart/form-data" method="post" >
              ...
              <div class="form-group row">
						    ...
						    <div class="col-sm-9">
									<input type="text" class="form-control numero" id="codigo_aleatorio" name="Codigo" placeholder="Digite un codigo como contraseña..."  required>
						    </div>
							</div>
