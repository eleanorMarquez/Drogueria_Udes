      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Agg Docente Administrador</li>
          </ol>
          ...
          <div class="row">
            <div class="col-xl-12 col-sm-6 mb-3">
              ...
              <h4>Digite los siguientes datos para un exitoso registro de un Docente Administrador</h4>
          ...
          <section class=" text-center">
            <form action="../funciones/crearAdmin.php" enctype="multipart/form-data" method="post" >
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control letra"  name="tipoAdmin" value="Docente-Administrador" >
                </div>
              </div>
