      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <section class=" text-center">
            <form action="../funciones/updateCliente.php" enctype="multipart/form-data" method="post" >
              ...
              <br>
						    ...
						    <div class="col-sm-8">
									<input type="text" class="form-control numero" name="Cedula" value="<?php echo $registros['Cedula']; ?>" placeholder="Digite su Cedula..." required>
						    </div>
							</div>
              ...
              <div class="form-group row">
						    ...
						    <div class="col-sm-8">
									<input type="text" class="form-control" name="direccion" value="<?php echo $registros['Direccion_residencia']; ?>" placeholder="Ejemplo: Calle XX N° XX Barrio XX" >
						    </div>
							</div>
						    ...
						    <div class="col-sm-8">
									<input type="email" class="form-control" name="tipoCliente" value="<?php echo $registros['Tipo_Usuario']; ?>" readonly="readonly"  required>
						    </div>
							</div>

              <div class="form-group row">
						    <div class="col-sm-8">
									<input type="text" name="numeroId" value="<?php echo $registros['id_cliente']; ?>">
						    </div>
							</div>
