      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="kardex.php">Inicio Sesion</a>
            <a class="dropdown-item" href="aggProductos.php">Producto vendido</a>
          ...
          <section class="" id="">
            <div class="container text-center table-responsive">
              ...
              <?php
                  ...
                  <div class="mb-8">
                    <h2><?php echo $registros['id_informe']; ?></h2>
                    <br>
                    <h4>Nombre del Usuario: <?php echo $registros['Nombre_Usuario']; ?></h4>
                    <h4>Hora de Salida del Usuaio: <?php echo $registros['Fecha_Salida']; ?></h4>
                    <br>
                    <h3>Productos:</h3>
                    <h4><?php echo $registros['Producto']; ?></h4>
                    <br> <br>
                  </div>
